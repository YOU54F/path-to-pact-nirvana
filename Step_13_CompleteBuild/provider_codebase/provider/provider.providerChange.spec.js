...
const pactFile = process.env.PACT_URL;

if (pactFile) {
  throw new Error(
    'this job should not run, if the process.env.PACT_URL is set'
  );
}
if (!currentGitBranch) {
  ...
  beforeAll(async () => {
    ...
    opts = {
      ...
      publishVerificationResult:
        process.env.PACT_BROKER_PUBLISH_VERIFICATION_RESULTS === true ?? false,
